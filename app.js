...
const FIELD_GROUPS = [
  ...
  },
  {
    title: "Mae",
    fields: [
      ["f1_nome", "Nome da mae", "wide"],
      ["f1_email", "E-mail", "email"],
      ["f1_dtnascimento", "Data de nascimento", "date"],
      ["f1_nacionalidade", "Nacionalidade"],
      ["f1_cpf", "CPF"],
      ["f1_rg", "RG"],
      ["f1_civil", "Estado civil"],
      ["f1_ocupacao", "Ocupacao"],
      ["f1_cel", "Celular", "tel"],
      ["f1_residencial", "Telefone residencial", "tel"],
      ["f1_comercial", "Telefone comercial", "tel"],
      ["f1_cep", "CEP"],
      ["f1_uf", "UF"],
      ["f1_municipio", "Municipio"],
      ["f1_bairro", "Bairro"],
      ["f1_endereco", "Endereco", "wide"],
  ...
  },
  {
    title: "Pai",
    fields: [
      ["f2_nome", "Nome do pai", "wide"],
      ["f2_email", "E-mail", "email"],
      ["f2_dtnascimento", "Data de nascimento", "date"],
      ["f2_nacionalidade", "Nacionalidade"],
      ["f2_cpf", "CPF"],
      ["f2_rg", "RG"],
      ["f2_civil", "Estado civil"],
      ["f2_ocupacao", "Ocupacao"],
      ["f2_cel", "Celular", "tel"],
      ["f2_residencial", "Telefone residencial", "tel"],
      ["f2_comercial", "Telefone comercial", "tel"],
      ["f2_cep", "CEP"],
      ["f2_uf", "UF"],
      ["f2_municipio", "Municipio"],
      ["f2_bairro", "Bairro"],
      ["f2_endereco", "Endereco", "wide"],
  ...
  },
  {
    ...
    fields: [
      ["respf_nome", "Nome", "wide"],
      ["respf_cpf", "CPF"],
      ["respf_sexo", "Sexo", "select:sexo"],
      ["respf_dtnascimento", "Data de nascimento", "date"],
      ["respf_rg", "RG"],
      ["respf_dtemissao", "Data de emissao", "date"],
      ["respf_expedidor", "Expedidor"],
      ["respf_nacionalidade", "Nacionalidade"],
      ["respf_estadocivil", "Estado civil"],
      ["respf_ocupacao", "Ocupacao"],
      ["respf_parentesco", "Grau de parentesco"],
      ["respf_email", "E-mail", "email"],
      ["respf_residencial", "Telefone residencial", "tel"],
      ["respf_cel", "Celular", "tel"],
      ["respf_cep", "CEP"],
      ["respf_uf", "Estado"],
      ["respf_cidade", "Cidade"],
      ["respf_bairro", "Bairro"],
      ["respf_endereco", "Endereco", "wide"],
      ["respf_numero", "Numero"],
  ...
  },
  {
    ...
    fields: [
      ["respa_nome", "Nome", "wide"],
      ["respa_cpf", "CPF"],
      ["respa_sexo", "Sexo", "select:sexo"],
      ["respa_dtnascimento", "Data de nascimento", "date"],
      ["respa_rg", "RG"],
      ["respa_dtemissao", "Data de emissao", "date"],
      ["respa_expedidor", "Expedidor"],
      ["respa_ocupacao", "Ocupacao"],
      ["respa_parentesco", "Grau de parentesco"],
      ["respa_email", "E-mail", "email"],
      ["respa_residencial", "Telefone residencial", "tel"],
      ["respa_cel", "Celular", "tel"],
      ["respa_cep", "CEP"],
      ["respa_uf", "Estado"],
      ["respa_cidade", "Cidade"],
      ["respa_bairro", "Bairro"],
      ["respa_endereco", "Endereco", "wide"],
      ["respa_numero", "Numero"],
  ...
  },
  {
    ...
    fields: [
      ...
      ["atividadefisicasn", "Restricao atividade fisica"],
    ],
  },
  {
